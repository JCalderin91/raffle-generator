        ...
        <div class="card-body px-5 py-4">
            <form action="{{route('login')}}" method="POST">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" id="emailInput" name="username" value="{{old('username')}}">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="password" class="form-control" id="passwordInput" name="password" placeholder="****************" value="{{old('password')}}">
                </div>
