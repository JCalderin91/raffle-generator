        ...
        <div class="card-body px-5 py-4">
            <form action="{{route('login')}}" method="POST">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="uasername" class="form-control" id="emailInput" placeholder="name@example.com" value="{{old('email')}}">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="password" class="form-control" id="passwordInput" placeholder="****************" value="{{old('password')}}">
                </div>
