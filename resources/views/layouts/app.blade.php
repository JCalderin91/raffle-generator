...
<head>
    ...
    <title>@yield('title', 'Generador de rifas - ATIN')</title>
...
<body>
    <nav class="navbar bg-dark navbar-expand-lg bg-body-tertiary shadow" data-bs-theme="dark">
        <div class="container">
            <a class="navbar-brand" href="/">Generador de rifas</a>
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    <li class="nav-item">
                        <a class="nav-link d-flex gap-2 align-items-center {{ Route::currentRouteName() == 'participants.index' ? 'active' : '' }}"
                    ...
                    <li class="nav-item">
                        <a class="nav-link d-flex gap-2 align-items-center {{ Route::currentRouteName() == 'raffles.create' ? 'active' : '' }}"
                            href="{{ route('raffles.create') }}"> <svg xmlns="http://www.w3.org/2000/svg" width="16"
                    ...
                    <li class="nav-item">
                        <form action="{{route('logout')}}" method="POST" class="d-lg-none">
                            @csrf
                            <button type="submit" class="nav-link" title="Cerrar sistema">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <form action="{{route('logout')}}" method="POST" class="d-none d-lg-inline-block ">
                    @csrf
                    <button type="submit" class="btn btn-outline-danger ms-md-2" title="Cerrar sistema">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6>El cartón con el numero {{session('participant')['number']}} pertenece a:</h6>
